                    ...
                    <ul class="fixed bg-white inset-0 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center"
                        ...
                        @foreach ($category as $item)
                            <li class="mx-3 py-6 md:py-0">
                                <a href="#"
                                    class="text-black md:text-white hover:underline">{{ $item->name }}</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
                <div class="w-auto">
                    <ul class="items-center flex">
                        @if (Auth::check())
                            ...
                            <li class="mx-3 py-6 md:py-0">
                                <a style="color: red" href="{{ route('admin.dashboard') }}"
                                    class="md:text-white hover:underline">ENTER</a>
                            </li>
                                <li class="ml-6 block md:hidden">
                                    <button id="menu-toggler"
                                        class="relative flex z-50 items-center justify-center w-8 h-8 md:text-white focus:outline-none">
                            ...
                            @else
                            <li class="mx-3 py-6 md:py-0">
                                <a style="color: red" href="{{ route('user.dashboard') }}"
                                    class="text-black md:text-white hover:underline">ENTER</a>
                            </li>
                                <li class="ml-6 block md:hidden">
                                    <button id="menu-toggler"
                        ...
                        @else
                            <li class="mx-3 py-6 md:py-0">
                                <a href="{{ route('login') }}"
                                    class="text-black md:text-white hover:underline">LOGIN</a>
                            </li>
                            <li class="mx-3 py-6 md:py-0">
                                <a href="{{ route('register') }}"
                                    class="text-black md:text-white hover:underline">REGISTER</a>
                            </li>
                        @endif
