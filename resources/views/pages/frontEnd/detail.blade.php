            ...
            <div class="flex flex-wrap my-4 md:my-12">
                ...
                <div class="flex-1">
                    <div class="slider">
                        <div class="thumbnail">
                            <div class="px-2">
                                <div class="item selected" data-img="{{ asset('frontend/images/content/favicon.png') }}pg">
                                    <img src="{{ asset('frontend/images/content/favicon.png') }}ont"
                                        class="object-cover w-full h-full rounded-lg" />
                                </div>
                            </div>
                            <div class="px-2">
                                <div class="item" data-img="{{ asset('frontend/images/content/favicon.png') }}pg">
                                    <img src="{{ asset('frontend/images/content/favicon.png') }}ack"
                                        class="object-cover w-full h-full rounded-lg" />
                                </div>
                            </div>
                            <div class="px-2">
                                <div class="item" data-img="{{ asset('frontend/images/content/favicon.png') }}pg">
                                    <img src="{{ asset('frontend/images/content/favicon.png') }}ear"
                                        class="object-cover w-full h-full rounded-lg" />
                                </div>
                            </div>
                            <div class="px-2">
                                <div class="item" data-img="{{ asset('frontend/images/content/favicon.png') }}pg">
                                    <img src="{{ asset('frontend/images/content/favicon.png') }}ide"
                                        class="object-cover w-full h-full rounded-lg" />
                                </div>
                            </div>
                            <div class="px-2">
                                <div class="item" data-img="{{ asset('frontend/images/content/favicon.png') }}pg">
                                    <img src="{{ asset('frontend/images/content/favicon.png') }}top"
                                        class="object-cover w-full h-full rounded-lg" />
                                </div>
                            </div>
                        </div>
