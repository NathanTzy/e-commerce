        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                ...
                <ul id="components-nav"
                    class="nav-content {{ request()->routeIs('admin.category.*', 'admin.product.*', 'admin.product.gallery') ? 'show' : '' }}"
            ...
            <li class="nav-item">
                ...
                <ul id="component-transaction"
                    class="nav-content {{ request()->routeIs('admin.transaction.*', 'admin.product.*') ? 'show' : '' }} "
                    data-bs-parent="#sidebar-nav">
                    <li>
                    ...
                    <li>
                        <a href="{{ route('admin.myTransaction.index') }}"
                            class="{{ request()->routeIs('admin.myTransaction.*') ? 'active' : '' }}">
